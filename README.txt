  ...
  # Reproduction instructions
    ...
    4. Run ipynb files in "./02_plot_figs"
      ...
      # generate_Figure8.ipynb
        This code generates a figure of synaptic connection (Figure8) from hemibrain (v.1.2.1) connectome database. 
...
# Files
  ...
  # SourceData
    Source data for figures 2-5 and 8 and Supplementary Figures 1-7 and 9-11 are provided as a source data file.    
