...
end DSSN_NP1227_class1;
architecture Behavioral of DSSN_NP1227_class1 is
    ...
    SIGNAL cov_vv_vS_0 : std_logic_vector(21 downto 0);
    SIGNAL cov_vv_vS_1 : std_logic_vector(21 downto 0);
    SIGNAL cov_vv_vS_2 : std_logic_vector(21 downto 0);
    SIGNAL cov_vv_vS_3 : std_logic_vector(21 downto 0);
    ...
    SIGNAL cov_vv_vL_6 : std_logic_vector(27 downto 0);
    SIGNAL cov_vv_vL_7 : std_logic_vector(27 downto 0);
    SIGNAL cov_vv_vL_8 : std_logic_vector(27 downto 0);
    SIGNAL cov_vv_vL_9 : std_logic_vector(27 downto 0);
    SIGNAL cov_v_vS : std_logic_vector(17 downto 0);
    SIGNAL cov_v_vS_0 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_1 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_2 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_3 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_4 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_5 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vS_6 : std_logic_vector(24 downto 0);
    SIGNAL cov_v_vL : std_logic_vector(17 downto 0);
    SIGNAL cov_v_vL_0 : std_logic_vector(22 downto 0);
    SIGNAL cov_v_vL_1 : std_logic_vector(22 downto 0);
    SIGNAL cov_v_vL_2 : std_logic_vector(22 downto 0);
    SIGNAL cov_v_vL_3 : std_logic_vector(22 downto 0);
    SIGNAL cov_v_vL_4 : std_logic_vector(22 downto 0);
    SIGNAL cov_v_vL_5 : std_logic_vector(22 downto 0);
    ...
    SIGNAL con_vv_vL_0 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_1 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_2 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_3 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_4 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_5 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_6 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_7 : std_logic_vector(25 downto 0);
    SIGNAL con_vv_vL_8 : std_logic_vector(25 downto 0);
    ...
    SIGNAL coq_vv_vL_0 : std_logic_vector(26 downto 0);
    SIGNAL coq_vv_vL_1 : std_logic_vector(26 downto 0);
    SIGNAL coq_vv_vL_2 : std_logic_vector(26 downto 0);
    SIGNAL coq_vv_vL_3 : std_logic_vector(26 downto 0);
    ...
    SIGNAL cov_vS : std_logic_vector(17 downto 0):="111111010100100110";-- -2.712890625
    SIGNAL cov_vL : std_logic_vector(17 downto 0):="111111010100100111";-- -2.7119140625
    SIGNAL con_vS : std_logic_vector(17 downto 0):="111110011101111100";-- -6.12890625
    SIGNAL con_vL : std_logic_vector(17 downto 0):="111111110100011010";-- -0.724609375
    SIGNAL coq_vS : std_logic_vector(17 downto 0):="111111111111111000";-- -0.0078125
    SIGNAL coq_vL : std_logic_vector(17 downto 0):="000000000000011100";-- 0.02734375
    ...
    SIGNAL crg : std_logic_vector(17 downto 0):="111111100100101000";-- -1.7109375
    SIGNAL crh : std_logic_vector(17 downto 0):="111111100100111101";-- -1.6904296875
    ...
    SIGNAL vini : std_logic_vector(17 downto 0):="111110110101000000";-- -4.6875
    SIGNAL nini : std_logic_vector(17 downto 0):="111111101111100000";-- -1.03125
    SIGNAL qini : std_logic_vector(17 downto 0):="111111011001000101";-- -2.4326171875
...
BEGIN
    ...
    Iin <= "000000001000000000" when I18>"000000001000000000" else "111111111000000000" when I18<"111111111000000000" else I18;
    vv <= vv36(27 downto 10 );
    -- vv * 0.1953125 : 00000000.0011001000    22bit
    cov_vv_vS_0 <= "000" & vv(17 downto 0) & "0" when vv(17)='0' else "111" & vv(17 downto 0) & "0";
    cov_vv_vS_1 <= "0000" & vv(17 downto 0) & "" when vv(17)='0' else "1111" & vv(17 downto 0) & "";
    cov_vv_vS_2 <= "0000000" & vv(17 downto 3) & "" when vv(17)='0' else "1111111" & vv(17 downto 3) & "";
    cov_vv_vS_3 <= cov_vv_vS_0 + cov_vv_vS_1 + cov_vv_vS_2;
    cov_vv_vS <= cov_vv_vS_3(21 downto 4);

    -- vv * -1.7470703125 : 00000001.1011111101    28bit
    cov_vv_vL_0 <= vv & "0000000000";
    cov_vv_vL_1 <= "0" & vv(17 downto 0) & "000000000" when vv(17)='0' else "1" & vv(17 downto 0) & "000000000";
    cov_vv_vL_2 <= "000" & vv(17 downto 0) & "0000000" when vv(17)='0' else "111" & vv(17 downto 0) & "0000000";
    cov_vv_vL_3 <= "0000" & vv(17 downto 0) & "000000" when vv(17)='0' else "1111" & vv(17 downto 0) & "000000";
    cov_vv_vL_4 <= "00000" & vv(17 downto 0) & "00000" when vv(17)='0' else "11111" & vv(17 downto 0) & "00000";
    cov_vv_vL_5 <= "000000" & vv(17 downto 0) & "0000" when vv(17)='0' else "111111" & vv(17 downto 0) & "0000";
    cov_vv_vL_6 <= "0000000" & vv(17 downto 0) & "000" when vv(17)='0' else "1111111" & vv(17 downto 0) & "000";
    cov_vv_vL_7 <= "00000000" & vv(17 downto 0) & "00" when vv(17)='0' else "11111111" & vv(17 downto 0) & "00";
    cov_vv_vL_8 <= "0000000000" & vv(17 downto 0) & "" when vv(17)='0' else "1111111111" & vv(17 downto 0) & "";
    cov_vv_vL_9 <= not (cov_vv_vL_0 + cov_vv_vL_1 + cov_vv_vL_2 + cov_vv_vL_3 + cov_vv_vL_4 + cov_vv_vL_5 + cov_vv_vL_6 + cov_vv_vL_7 + cov_vv_vL_8) + 1;
    cov_vv_vL <= cov_vv_vL_9(27 downto 10);

    -- vin * 0.46484375 : 00000000.0111011100    25bit
    cov_v_vS_0 <= "00" & vin(17 downto 0) & "00000" when vin(17)='0' else "11" & vin(17 downto 0) & "00000";
    cov_v_vS_1 <= "000" & vin(17 downto 0) & "0000" when vin(17)='0' else "111" & vin(17 downto 0) & "0000";
    cov_v_vS_2 <= "0000" & vin(17 downto 0) & "000" when vin(17)='0' else "1111" & vin(17 downto 0) & "000";
    cov_v_vS_3 <= "000000" & vin(17 downto 0) & "0" when vin(17)='0' else "111111" & vin(17 downto 0) & "0";
    cov_v_vS_4 <= "0000000" & vin(17 downto 0) & "" when vin(17)='0' else "1111111" & vin(17 downto 0) & "";
    cov_v_vS_5 <= "00000000" & vin(17 downto 1) & "" when vin(17)='0' else "11111111" & vin(17 downto 1) & "";
    cov_v_vS_6 <= cov_v_vS_0 + cov_v_vS_1 + cov_v_vS_2 + cov_v_vS_3 + cov_v_vS_4 + cov_v_vS_5;
    cov_v_vS <= cov_v_vS_6(24 downto 7);

    -- vin * 0.470703125 : 00000000.0111100010    23bit
    cov_v_vL_0 <= "00" & vin(17 downto 0) & "000" when vin(17)='0' else "11" & vin(17 downto 0) & "000";
    cov_v_vL_1 <= "000" & vin(17 downto 0) & "00" when vin(17)='0' else "111" & vin(17 downto 0) & "00";
    cov_v_vL_2 <= "0000" & vin(17 downto 0) & "0" when vin(17)='0' else "1111" & vin(17 downto 0) & "0";
    cov_v_vL_3 <= "00000" & vin(17 downto 0) & "" when vin(17)='0' else "11111" & vin(17 downto 0) & "";
    cov_v_vL_4 <= "000000000" & vin(17 downto 4) & "" when vin(17)='0' else "111111111" & vin(17 downto 4) & "";
    cov_v_vL_5 <= cov_v_vL_0 + cov_v_vL_1 + cov_v_vL_2 + cov_v_vL_3 + cov_v_vL_4;
    cov_v_vL <= cov_v_vL_5(22 downto 5);

    -- nin * -0.173828125 : 00000000.0010110010    28bit
    cov_n_0 <= "000" & nin(17 downto 0) & "0000000" when nin(17)='0' else "111" & nin(17 downto 0) & "0000000";
    cov_n_1 <= "00000" & nin(17 downto 0) & "00000" when nin(17)='0' else "11111" & nin(17 downto 0) & "00000";
    cov_n_2 <= "000000" & nin(17 downto 0) & "0000" when nin(17)='0' else "111111" & nin(17 downto 0) & "0000";
    ...
    -- qin * -0.173828125 : 00000000.0010110010    28bit
    cov_q_0 <= "000" & qin(17 downto 0) & "0000000" when qin(17)='0' else "111" & qin(17 downto 0) & "0000000";
    cov_q_1 <= "00000" & qin(17 downto 0) & "00000" when qin(17)='0' else "11111" & qin(17 downto 0) & "00000";
    cov_q_2 <= "000000" & qin(17 downto 0) & "0000" when qin(17)='0' else "111111" & qin(17 downto 0) & "0000";
    ...
    -- Iin * 5.5869140625 : 00000101.1001011001    25bit
    cov_Istim_0 <= Iin( 15 downto 0) & "000000000";
    cov_Istim_1 <= Iin & "0000000";
    cov_Istim_2 <= "0" & Iin(17 downto 0) & "000000" when Iin(17)='0' else "1" & Iin(17 downto 0) & "000000";
    cov_Istim_3 <= "0000" & Iin(17 downto 0) & "000" when Iin(17)='0' else "1111" & Iin(17 downto 0) & "000";
    ...
    cov_Istim_6 <= "0000000000" & Iin(17 downto 3) & "" when Iin(17)='0' else "1111111111" & Iin(17 downto 3) & "";
    ...
    -- vv * -0.1591796875 : 00000000.0010100011    28bit
    con_vv_vS_0 <= "000" & vv(17 downto 0) & "0000000" when vv(17)='0' else "111" & vv(17 downto 0) & "0000000";
    con_vv_vS_1 <= "00000" & vv(17 downto 0) & "00000" when vv(17)='0' else "11111" & vv(17 downto 0) & "00000";
    con_vv_vS_2 <= "000000000" & vv(17 downto 0) & "0" when vv(17)='0' else "111111111" & vv(17 downto 0) & "0";
    con_vv_vS_3 <= "0000000000" & vv(17 downto 0) & "" when vv(17)='0' else "1111111111" & vv(17 downto 0) & "";
    con_vv_vS_4 <= not (con_vv_vS_0 + con_vv_vS_1 + con_vv_vS_2 + con_vv_vS_3) + 1;
    con_vv_vS <= con_vv_vS_4(27 downto 10);

    -- vv * 1.685546875 : 00000001.1010111110    26bit
    con_vv_vL_0 <= vv & "00000000";
    con_vv_vL_1 <= "0" & vv(17 downto 0) & "0000000" when vv(17)='0' else "1" & vv(17 downto 0) & "0000000";
    con_vv_vL_2 <= "000" & vv(17 downto 0) & "00000" when vv(17)='0' else "111" & vv(17 downto 0) & "00000";
    con_vv_vL_3 <= "00000" & vv(17 downto 0) & "000" when vv(17)='0' else "11111" & vv(17 downto 0) & "000";
    con_vv_vL_4 <= "000000" & vv(17 downto 0) & "00" when vv(17)='0' else "111111" & vv(17 downto 0) & "00";
    con_vv_vL_5 <= "0000000" & vv(17 downto 0) & "0" when vv(17)='0' else "1111111" & vv(17 downto 0) & "0";
    con_vv_vL_6 <= "00000000" & vv(17 downto 0) & "" when vv(17)='0' else "11111111" & vv(17 downto 0) & "";
    con_vv_vL_7 <= "000000000" & vv(17 downto 1) & "" when vv(17)='0' else "111111111" & vv(17 downto 1) & "";
    con_vv_vL_8 <= con_vv_vL_0 + con_vv_vL_1 + con_vv_vL_2 + con_vv_vL_3 + con_vv_vL_4 + con_vv_vL_5 + con_vv_vL_6 + con_vv_vL_7;
    con_vv_vL <= con_vv_vL_8(25 downto 8);

    -- vin * -2.0263671875 : 00000010.0000011011    28bit
    con_v_vS_0 <= vin( 16 downto 0) & "00000000000";
    con_v_vS_1 <= "000000" & vin(17 downto 0) & "0000" when vin(17)='0' else "111111" & vin(17 downto 0) & "0000";
    con_v_vS_2 <= "0000000" & vin(17 downto 0) & "000" when vin(17)='0' else "1111111" & vin(17 downto 0) & "000";
    con_v_vS_3 <= "000000000" & vin(17 downto 0) & "0" when vin(17)='0' else "111111111" & vin(17 downto 0) & "0";
    con_v_vS_4 <= "0000000000" & vin(17 downto 0) & "" when vin(17)='0' else "1111111111" & vin(17 downto 0) & "";
    con_v_vS_5 <= not (con_v_vS_0 + con_v_vS_1 + con_v_vS_2 + con_v_vS_3 + con_v_vS_4) + 1;
    con_v_vS <= con_v_vS_5(27 downto 10);

    -- vin * 4.279296875 : 00000100.0100011110    26bit
    con_v_vL_0 <= vin( 15 downto 0) & "0000000000";
    con_v_vL_1 <= "00" & vin(17 downto 0) & "000000" when vin(17)='0' else "11" & vin(17 downto 0) & "000000";
    con_v_vL_2 <= "000000" & vin(17 downto 0) & "00" when vin(17)='0' else "111111" & vin(17 downto 0) & "00";
    con_v_vL_3 <= "0000000" & vin(17 downto 0) & "0" when vin(17)='0' else "1111111" & vin(17 downto 0) & "0";
    con_v_vL_4 <= "00000000" & vin(17 downto 0) & "" when vin(17)='0' else "11111111" & vin(17 downto 0) & "";
    con_v_vL_5 <= "000000000" & vin(17 downto 1) & "" when vin(17)='0' else "111111111" & vin(17 downto 1) & "";
    con_v_vL_6 <= con_v_vL_0 + con_v_vL_1 + con_v_vL_2 + con_v_vL_3 + con_v_vL_4 + con_v_vL_5;
    con_v_vL <= con_v_vL_6(25 downto 8);
    ...
    -- vv * 0.0107421875 : 00000000.0000001011    27bit
    coq_vv_vL_0 <= "0000000" & vv(17 downto 0) & "00" when vv(17)='0' else "1111111" & vv(17 downto 0) & "00";
    coq_vv_vL_1 <= "000000000" & vv(17 downto 0) & "" when vv(17)='0' else "111111111" & vv(17 downto 0) & "";
    coq_vv_vL_2 <= "0000000000" & vv(17 downto 1) & "" when vv(17)='0' else "1111111111" & vv(17 downto 1) & "";
    coq_vv_vL_3 <= coq_vv_vL_0 + coq_vv_vL_1 + coq_vv_vL_2;
    coq_vv_vL <= coq_vv_vL_3(26 downto 9);

    -- vin * -0.005859375 : 00000000.0000000110    28bit
    coq_v_vS_0 <= "00000000" & vin(17 downto 0) & "00" when vin(17)='0' else "11111111" & vin(17 downto 0) & "00";
    coq_v_vS_1 <= "000000000" & vin(17 downto 0) & "0" when vin(17)='0' else "111111111" & vin(17 downto 0) & "0";
    coq_v_vS_2 <= not (coq_v_vS_0 + coq_v_vS_1) + 1;
    coq_v_vS <= coq_v_vS_2(27 downto 10);

    -- vin * 0.0341796875 : 00000000.0000100011    27bit
    coq_v_vL_0 <= "00000" & vin(17 downto 0) & "0000" when vin(17)='0' else "11111" & vin(17 downto 0) & "0000";
...
END Behavioral;
--cov_vv_vS=0.1953125
--cov_vv_vL=-1.7470703125
--cov_v_vS=0.46484375
--cov_v_vL=0.470703125
--cov_n=-0.173828125
--cov_q=-0.173828125
--cov_Istim=5.5869140625
--con_vv_vS=-0.1591796875
--con_vv_vL=1.685546875
--con_v_vS=-2.0263671875
--con_v_vL=4.279296875
--con_n=-0.125
--coq_vv_vS=-0.0009765625
--coq_vv_vL=0.0107421875
--coq_v_vS=-0.005859375
--coq_v_vL=0.0341796875
--coq_q=-0.0009765625
--cos_s_vS=-0.203125
--cos_s_vL=-0.25
--cov_vS=-2.712890625
