...
architecture Behavioral of DSSN_MBON is
...
BEGIN
    ...
    ---- sin * -0.0078125 : 00000000.0000001000    28bit
    --cos_s_vS_0 <= "0000000" & sin(17 downto 0) & "000" when sin(17)='0' else "1111111" & sin(17 downto 0) & "000";
    --cos_s_vS_1 <= not (cos_s_vS_0) + 1;
    --cos_s_vS <= cos_s_vS_1(27 downto 10);
