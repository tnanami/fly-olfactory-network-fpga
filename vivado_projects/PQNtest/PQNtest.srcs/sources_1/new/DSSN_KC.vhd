...
architecture Behavioral of DSSN_KC is
    ...
    SIGNAL cov_v_vS_0 : std_logic_vector(18 downto 0);
    SIGNAL cov_v_vS_1 : std_logic_vector(18 downto 0);
    SIGNAL cov_v_vS_2 : std_logic_vector(18 downto 0);
    SIGNAL cov_v_vL : std_logic_vector(17 downto 0);
    SIGNAL cov_v_vL_0 : std_logic_vector(18 downto 0);
    SIGNAL cov_v_vL_1 : std_logic_vector(18 downto 0);
    SIGNAL cov_v_vL_2 : std_logic_vector(18 downto 0);
    ...
    SIGNAL con_v_vL_2 : std_logic_vector(27 downto 0);
    ...
    SIGNAL coIgj1_0 : std_logic_vector(26 downto 0);
    SIGNAL coIgj1_1 : std_logic_vector(26 downto 0);
    SIGNAL coIgj1_2 : std_logic_vector(26 downto 0);
    SIGNAL coIgj1_3 : std_logic_vector(26 downto 0);
    ...
    SIGNAL coqIstim_0 : std_logic_vector(20 downto 0);
    SIGNAL coqIstim_1 : std_logic_vector(20 downto 0);
    SIGNAL coqIstim_2 : std_logic_vector(20 downto 0);
    SIGNAL cov_vS : std_logic_vector(17 downto 0):="111111110000011010";-- -0.9749999999999996
    SIGNAL cov_vL : std_logic_vector(17 downto 0):="111111110000011010";-- -0.9749999999999996
    SIGNAL con_vS : std_logic_vector(17 downto 0):="111111100000000000";-- -2.0
    SIGNAL con_vL : std_logic_vector(17 downto 0):="111111100001010000";-- -1.921875
    ...
    SIGNAL vini : std_logic_vector(17 downto 0):="111110111011000000";-- -4.3125
    SIGNAL nini : std_logic_vector(17 downto 0):="111110111111100100";-- -4.02734375
    SIGNAL qini : std_logic_vector(17 downto 0):="111110110010110000";-- -4.828125
    SIGNAL vth : std_logic_vector(17 downto 0):="000000000000000000";-- 0
    SIGNAL coqI0 : std_logic_vector(17 downto 0):="111111111011001000";-- -0.305
...
BEGIN
    ...
    BEGIN
        IF (rising_edge(CLK)) THEN
            ...
            -- 3rd stage
            IF vin_b0 < crf THEN
                vout_b0 <= vin_b0 + cov_vv_vS_b0 + cov_v_vS_b0 + cov_vS + cov_n_b0 + coqIgj0_b0;
            ELSE
                vout_b0 <= vin_b0 + cov_vv_vL_b0 + cov_v_vL_b0 + cov_vL + cov_n_b0 + coqIgj0_b0;
            END IF;
            IF vin_b0 < crg THEN
            ...
            END IF;
                qout_b0 <= qin_b0 + coqleak_b0 + coqI0_b0 + coqIgj1_b0 + coqIstim_b0;
            IF vin_b0 < vth THEN
    ...
    Iin <= I18;-- "000000010000000000" when I18>"000000010000000000" else "111111110000000000" when I18<"111111110000000000" else I18;
    vv <= vv36(27 downto 10 );
    -- vv * 0.125 : 00000000.0010000000    18bit
    cov_vv_vS <= "000" & vv(17 downto 3) when vv(17)='0' else "111" & vv(17 downto 3);
    ...
    -- vin * 0.75 : 00000000.1100000000    19bit
    cov_v_vS_0 <= "0" & vin(17 downto 0) & "" when vin(17)='0' else "1" & vin(17 downto 0) & "";
    cov_v_vS_1 <= "00" & vin(17 downto 1) & "" when vin(17)='0' else "11" & vin(17 downto 1) & "";
    cov_v_vS_2 <= cov_v_vS_0 + cov_v_vS_1;
    cov_v_vS <= cov_v_vS_2(18 downto 1);

    -- vin * 0.75 : 00000000.1100000000    19bit
    cov_v_vL_0 <= "0" & vin(17 downto 0) & "" when vin(17)='0' else "1" & vin(17 downto 0) & "";
    cov_v_vL_1 <= "00" & vin(17 downto 1) & "" when vin(17)='0' else "11" & vin(17 downto 1) & "";
    cov_v_vL_2 <= cov_v_vL_0 + cov_v_vL_1;
    cov_v_vL <= cov_v_vL_2(18 downto 1);
    ...
    -- qin * -0.5 : 00000000.1000000000    28bit
    ...
    -- Iin * 0.5 : 00000000.1000000000    18bit
    cov_Istim <= "0" & Iin(17 downto 1) when Iin(17)='0' else "1" & Iin(17 downto 1);
    ...
    -- vin * -0.5 : 00000000.1000000000    28bit
    con_v_vS_0 <= "0" & vin(17 downto 0) & "000000000" when vin(17)='0' else "1" & vin(17 downto 0) & "000000000";
    con_v_vS_1 <= not (con_v_vS_0) + 1;
    con_v_vS <= con_v_vS_1(27 downto 10);

    -- vin * -0.1875 : 00000000.0011000000    28bit
    con_v_vL_0 <= "000" & vin(17 downto 0) & "0000000" when vin(17)='0' else "111" & vin(17 downto 0) & "0000000";
    con_v_vL_1 <= "0000" & vin(17 downto 0) & "000000" when vin(17)='0' else "1111" & vin(17 downto 0) & "000000";
    con_v_vL_2 <= not (con_v_vL_0 + con_v_vL_1) + 1;
    con_v_vL <= con_v_vL_2(27 downto 10);
    ...
    -- sin * -0.1015625 : 00000000.0001101000    28bit
    cos_s_vS_0 <= "0000" & sin(17 downto 0) & "000000" when sin(17)='0' else "1111" & sin(17 downto 0) & "000000";
    cos_s_vS_1 <= "00000" & sin(17 downto 0) & "00000" when sin(17)='0' else "11111" & sin(17 downto 0) & "00000";
    cos_s_vS_2 <= "0000000" & sin(17 downto 0) & "000" when sin(17)='0' else "1111111" & sin(17 downto 0) & "000";
    ...
    -- vq * -0.25 : 00000000.0100000000    28bit
    ...
    -- vq * 0.0068359375 : 00000000.0000000111    27bit
    coIgj1_0 <= "00000000" & vq(17 downto 0) & "0" when vq(17)='0' else "11111111" & vq(17 downto 0) & "0";
    coIgj1_1 <= "000000000" & vq(17 downto 0) & "" when vq(17)='0' else "111111111" & vq(17 downto 0) & "";
    coIgj1_2 <= "0000000000" & vq(17 downto 1) & "" when vq(17)='0' else "1111111111" & vq(17 downto 1) & "";
    coIgj1_3 <= coIgj1_0 + coIgj1_1 + coIgj1_2;
    coIgj1 <= coIgj1_3(26 downto 9);

    -- qin * -0.0625 : 00000000.0001000000    28bit
    coqleak_0 <= "0000" & qin(17 downto 0) & "000000" when qin(17)='0' else "1111" & qin(17 downto 0) & "000000";
    coqleak_1 <= not (coqleak_0) + 1;
    coqleak <= coqleak_1(27 downto 10);

    -- Iin * 0.1875 : 00000000.0011000000    21bit
    coqIstim_0 <= "000" & Iin(17 downto 0) & "" when Iin(17)='0' else "111" & Iin(17 downto 0) & "";
    coqIstim_1 <= "0000" & Iin(17 downto 1) & "" when Iin(17)='0' else "1111" & Iin(17 downto 1) & "";
    coqIstim_2 <= coqIstim_0 + coqIstim_1;
    coqIstim <= coqIstim_2(20 downto 3);
...
--coqleak=-0.0625
--coqIstim=0.1875
--cov_vS=-0.9749999999999996
--cov_vL=-0.9749999999999996
--con_vS=-2.0
--con_vL=-1.921875
--coq_vS=0
--coq_vL=0
