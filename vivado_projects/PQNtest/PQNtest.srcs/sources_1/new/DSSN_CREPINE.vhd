...
architecture Behavioral of DSSN_CREPINE is
    ...
    SIGNAL cov_v_vS_0 : std_logic_vector(19 downto 0);
    SIGNAL cov_v_vS_1 : std_logic_vector(19 downto 0);
    SIGNAL cov_v_vS_2 : std_logic_vector(19 downto 0);
    SIGNAL cov_v_vL : std_logic_vector(17 downto 0);
    SIGNAL cov_v_vL_0 : std_logic_vector(19 downto 0);
    SIGNAL cov_v_vL_1 : std_logic_vector(19 downto 0);
    SIGNAL cov_v_vL_2 : std_logic_vector(19 downto 0);
    ...
    SIGNAL coqIstim_0 : std_logic_vector(22 downto 0);
    SIGNAL coqIstim_1 : std_logic_vector(22 downto 0);
    SIGNAL coqIstim_2 : std_logic_vector(22 downto 0);
    SIGNAL cov_vS : std_logic_vector(17 downto 0):="111111111000001101";-- -0.4874999999999998
    SIGNAL cov_vL : std_logic_vector(17 downto 0):="111111111000001101";-- -0.4874999999999998
    SIGNAL con_vS : std_logic_vector(17 downto 0):="111111111000000000";-- -0.5
    SIGNAL con_vL : std_logic_vector(17 downto 0):="111111111000010100";-- -0.48046875
    ...
    SIGNAL vini : std_logic_vector(17 downto 0):="111111000010000101";-- -3.8701171875
    SIGNAL nini : std_logic_vector(17 downto 0):="111110111111101111";-- -4.0166015625
    SIGNAL qini : std_logic_vector(17 downto 0):="111111000001000000";-- -3.9375
    SIGNAL vth : std_logic_vector(17 downto 0):="000000000000000000";-- 0
    SIGNAL coqI0 : std_logic_vector(17 downto 0):="111111111111000001";-- -0.0621875
...
BEGIN
    ...
    cov_vv_vS <= "0000" & vv(17 downto 4) when vv(17)='0' else "1111" & vv(17 downto 4);
    ...
    -- vin * 0.375 : 00000000.0110000000    20bit
    cov_v_vS_0 <= "00" & vin(17 downto 0) & "" when vin(17)='0' else "11" & vin(17 downto 0) & "";
    cov_v_vS_1 <= "000" & vin(17 downto 1) & "" when vin(17)='0' else "111" & vin(17 downto 1) & "";
    cov_v_vS_2 <= cov_v_vS_0 + cov_v_vS_1;
    cov_v_vS <= cov_v_vS_2(19 downto 2);

    -- vin * 0.375 : 00000000.0110000000    20bit
    cov_v_vL_0 <= "00" & vin(17 downto 0) & "" when vin(17)='0' else "11" & vin(17 downto 0) & "";
    cov_v_vL_1 <= "000" & vin(17 downto 1) & "" when vin(17)='0' else "111" & vin(17 downto 1) & "";
    cov_v_vL_2 <= cov_v_vL_0 + cov_v_vL_1;
    cov_v_vL <= cov_v_vL_2(19 downto 2);
    ...
    -- Iin * 0.25 : 00000000.0100000000    18bit
    cov_Istim <= "00" & Iin(17 downto 2) when Iin(17)='0' else "11" & Iin(17 downto 2);

    -- vv * -0.015625 : 00000000.0000010000    28bit
    con_vv_vS_0 <= "000000" & vv(17 downto 0) & "0000" when vv(17)='0' else "111111" & vv(17 downto 0) & "0000";
    ...
    con_v_vS_0 <= "000" & vin(17 downto 0) & "0000000" when vin(17)='0' else "111" & vin(17 downto 0) & "0000000";
    con_v_vS_1 <= not (con_v_vS_0) + 1;
    con_v_vS <= con_v_vS_1(27 downto 10);

    -- vin * -0.046875 : 00000000.0000110000    28bit
    con_v_vL_0 <= "00000" & vin(17 downto 0) & "00000" when vin(17)='0' else "11111" & vin(17 downto 0) & "00000";
    con_v_vL_1 <= "000000" & vin(17 downto 0) & "0000" when vin(17)='0' else "111111" & vin(17 downto 0) & "0000";
    ...
    -- sin * -0.025390625 : 00000000.0000011010    28bit
    cos_s_vS_0 <= "000000" & sin(17 downto 0) & "0000" when sin(17)='0' else "111111" & sin(17 downto 0) & "0000";
    cos_s_vS_1 <= "0000000" & sin(17 downto 0) & "000" when sin(17)='0' else "1111111" & sin(17 downto 0) & "000";
    cos_s_vS_2 <= "000000000" & sin(17 downto 0) & "0" when sin(17)='0' else "111111111" & sin(17 downto 0) & "0";
    ...
    -- Iin * 0.046875 : 00000000.0000110000    23bit
    coqIstim_0 <= "00000" & Iin(17 downto 0) & "" when Iin(17)='0' else "11111" & Iin(17 downto 0) & "";
    coqIstim_1 <= "000000" & Iin(17 downto 1) & "" when Iin(17)='0' else "111111" & Iin(17 downto 1) & "";
    coqIstim_2 <= coqIstim_0 + coqIstim_1;
    coqIstim <= coqIstim_2(22 downto 5);
...
--coq_v_vL=0
--coq_q=0
--cos_s_vS=-0.025390625
--cos_s_vL=-0.25
--coIgj0=-0.0
--coIgj1=0.0
--coqleak=-0.015625
--coqIstim=0.046875
--cov_vS=-0.4874999999999998
--cov_vL=-0.4874999999999998
--con_vS=-0.5
--con_vL=-0.48046875
--coq_vS=0
--coq_vL=0
