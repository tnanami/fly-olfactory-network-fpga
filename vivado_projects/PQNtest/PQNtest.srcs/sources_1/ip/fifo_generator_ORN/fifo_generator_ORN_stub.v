...
// Command     : write_verilog -force -mode synth_stub -rename_top fifo_generator_ORN -prefix
//               fifo_generator_ORN_ fifo_generator_ORN_stub.v
...
module fifo_generator_ORN(clk, srst, din, wr_en, rd_en, dout, full, empty)
