...
#set_property MARK_DEBUG false [get_nets {Inst_UART_RX_CTRL/BIT_INDEX[0]_i_1_n_0}]
...
#set_input_delay -clock [get_clocks [get_clocks -of_objects [get_pins inst_clk/inst/mmcm_adv_inst/CLKOUT0]]] -max 2.000 [get_ports uart_txd_in]
#set_input_delay -clock [get_clocks [get_clocks -of_objects [get_pins inst_clk/inst/mmcm_adv_inst/CLKOUT0]]] -min 1.000 [get_ports uart_txd_in]
#set_output_delay -clock [get_clocks [get_clocks -of_objects [get_pins inst_clk/inst/mmcm_adv_inst/CLKOUT0]]] 1.000 [get_ports UART_TXD]
