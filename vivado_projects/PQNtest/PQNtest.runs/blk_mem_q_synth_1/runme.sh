...
HD_PWD='D:/research/Xilinx/DrosophilaOlfactorySystem20201127/DrosophilaOlfactorySystem20201127.runs/blk_mem_q_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_q.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_q.tcl
