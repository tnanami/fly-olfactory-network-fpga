...
#
# Generated by export_simulation on Wed Jan 13 22:22:08 +0900 2021
#
################################################################################
...
switch to the './blk_mem_gen_ORN_sc.sh' script.

./blk_mem_gen_ORN_sc.sh -reset_run
...
./blk_mem_gen_ORN_sc.sh -noclean_files

For more information on the script, please type './blk_mem_gen_ORN_sc.sh -help'.
