...
#
# Generated by export_simulation on Tue Feb 02 22:25:28 +0900 2021
#
################################################################################
...
switch to the './blk_mem_KC_sr.sh' script.

./blk_mem_KC_sr.sh -reset_run
...
./blk_mem_KC_sr.sh -noclean_files

For more information on the script, please type './blk_mem_KC_sr.sh -help'.
