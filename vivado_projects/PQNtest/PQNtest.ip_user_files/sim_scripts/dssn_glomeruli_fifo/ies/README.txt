...
#
# Generated by export_simulation on Thu Jul 08 23:36:20 +0900 2021
#
################################################################################
...
switch to the './dssn_glomeruli_fifo.sh' script.

./dssn_glomeruli_fifo.sh -reset_run
...
./dssn_glomeruli_fifo.sh -noclean_files

For more information on the script, please type './dssn_glomeruli_fifo.sh -help'.
