...
#
# Generated by export_simulation on Tue Mar 02 18:20:26 +0900 2021
#
################################################################################
...
switch to the './blk_mem_fc.sh' script.

./blk_mem_fc.sh -reset_run
...
./blk_mem_fc.sh -noclean_files

For more information on the script, please type './blk_mem_fc.sh -help'.
