...
architecture Behavioral of PQN_KC is
    ...
    SIGNAL vini : std_logic_vector(17 downto 0):="111111000001001001";-- -3.9287109375
    SIGNAL nini : std_logic_vector(17 downto 0):="111110111111111001";-- -4.0068359375
    SIGNAL qini : std_logic_vector(17 downto 0):="111111000000100000";-- -3.96875
    SIGNAL vth : std_logic_vector(17 downto 0):="000000000000000000";-- 0
    SIGNAL coqI0 : std_logic_vector(17 downto 0):="111111111100000010";-- -0.24875
...
BEGIN
    ...
    BEGIN
        ...
        END IF;
    END PROCESS;
    Iin <= "000000010000000000" when I18>"000000010000000000" else "111111110000000000" when I18<"111111110000000000" else I18;
   ...
   -- -- sin * -0.203125 : 00000000.0011010000    28bit
    cos_s_vS_0 <= "00000" & sin(17 downto 0) & "00000" when sin(17)='0' else "11111" & sin(17 downto 0) & "00000";
    cos_s_vS_1 <= "000000" & sin(17 downto 0) & "0000" when sin(17)='0' else "111111" & sin(17 downto 0) & "0000";
    cos_s_vS_2 <= "00000000" & sin(17 downto 0) & "00" when sin(17)='0' else "11111111" & sin(17 downto 0) & "00";
