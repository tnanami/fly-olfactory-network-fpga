...
end PQN_NP1227_class1;
architecture Behavioral of PQN_NP1227_class1 is
...
BEGIN
    ...
    BEGIN
        ...
        END IF;
    END PROCESS;
    Iin <= "000000001000000000" when I18>"000000001000000000" else "111111111000000000" when I18<"111111111000000000" else I18;--0
