...
#
# Generated by export_simulation on Fri Mar 24 14:16:41 +0900 2023
#
################################################################################
...
switch to the './blk_mem_n.sh' script.

./blk_mem_n.sh -reset_run
...
./blk_mem_n.sh -noclean_files

For more information on the script, please type './blk_mem_n.sh -help'.
