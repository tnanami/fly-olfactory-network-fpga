...
#
# Generated by export_simulation on Fri Mar 24 14:15:27 +0900 2023
#
################################################################################
...
switch to the './blk_mem_v.sh' script.

./blk_mem_v.sh -reset_run
...
./blk_mem_v.sh -noclean_files

For more information on the script, please type './blk_mem_v.sh -help'.
