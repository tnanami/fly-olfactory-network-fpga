...
#
# Generated by export_simulation on Fri Mar 24 15:22:57 +0900 2023
#
################################################################################
...
switch to the './fifo_rxd.sh' script.

./fifo_rxd.sh -reset_run
...
./fifo_rxd.sh -noclean_files

For more information on the script, please type './fifo_rxd.sh -help'.
