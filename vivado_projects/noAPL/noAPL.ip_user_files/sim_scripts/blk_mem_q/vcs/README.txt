...
#
# Generated by export_simulation on Fri Mar 24 14:17:16 +0900 2023
#
################################################################################
...
switch to the './blk_mem_q.sh' script.

./blk_mem_q.sh -reset_run
...
./blk_mem_q.sh -noclean_files

For more information on the script, please type './blk_mem_q.sh -help'.
