...
HD_PWD='D:/research/Jupyter/release/fly-olfactory-network-fpga/NeuralNetworks/code_and_data/vivado_projects/FlyOlfactoryNetwork/FlyOlfactoryNetwork.runs/impl_2'
cd "$HD_PWD"
