...
HD_PWD='D:/research/Jupyter/release/fly-olfactory-network-fpga/NeuralNetworks/code_and_data/vivado_projects/FlyOlfactoryNetwork/FlyOlfactoryNetwork.runs/synth_1'
cd "$HD_PWD"
